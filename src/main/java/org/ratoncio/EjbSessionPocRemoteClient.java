...
public class EjbSessionPocRemoteClient extends HttpServlet{
   ...
   public EjbSessionPocRemoteClient(){
    ...
    try {
        ...
        String jndi;
        jndi = "org.ratoncio.EjbSessionPocRemote";
        jndi = "ejb/ejb-app/ejb-app.war/EjbBean#org.ratoncio.EjbSessionPocRemote";
        jndi = "java:global/ejb-app/EjbBean!org.ratoncio.EjbSessionPocRemote";
        /*
